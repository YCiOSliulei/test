...
@interface more1ViewControllView ()<UITextFieldDelegate,UIGestureRecognizerDelegate>
{
...
@implementation more1ViewControllView
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        [_button3 setImage:[UIImage imageNamed:@"more_k2"] forState:UIControlStateNormal];
        _button3.userInteractionEnabled = NO;
        
        tf_tel = [[UITextField alloc]initWithFrame:CGRectMake(75 * kSceneScale,
                                                              _button3.top+40*kSceneScale,
                                                              190* kSceneScale,
                                                              45* kSceneScale)];
        tf_tel.backgroundColor =[UIColor whiteColor];
        tf_tel.borderStyle = UITextBorderStyleNone;
        tf_tel.placeholder = @"输入回拨延时分钟数";
        ...
        [_button4 setImage:[UIImage imageNamed:@"more_k3.png"] forState:UIControlStateNormal];
        [_button4 setImage:[UIImage imageNamed:@"more_k3.png"] forState:UIControlStateHighlighted];
