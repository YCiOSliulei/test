...
@implementation originSettingView
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        [_button1 setImage:[UIImage imageNamed:@"chushi_k1"] forState:UIControlStateNormal];
        [_button1 setImage:[UIImage imageNamed:@"chushi_k1"] forState:UIControlStateHighlighted];
        ...
        [_button4 setImage:[UIImage imageNamed:@"chushi_k4"] forState:UIControlStateNormal];
        [_button4 setImage:[UIImage imageNamed:@"chushi_k4"] forState:UIControlStateHighlighted];
