...
//  iLiTTLE
//
//  Created by 刘雷 on 15/6/14.
//  Copyright (c) 2015年 yc. All rights reserved.
//

#ifndef iLiTTLE_ILIttleDefine_h
#define iLiTTLE_ILIttleDefine_h
...
#define kSceneScale ([ILIttleUtility sceneScale])
...
#define PROJECTS_ARRAY @"projrctsArray"
#define TEAMS_ARRAY @"teamsArray"
...
#define GLOBAL_KEYBOARD_APPEAR_TIME (0.5)
...
// 版本
#define ClientVersion @"3.2.16"//可能出错@"2.3.0"
